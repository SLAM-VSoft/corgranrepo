	...
	<div class="container-fluid">
		...
		<div class="row mb-3">
			<div class="col-md-9">
			    ...
			    <hr>
			    <div class="col-sm-12 card-background p-3">
			        <div class="card-footer text-muted mb-3">
                    13/03/2018
                    </div>
                    <div class="col clearfix p-0">
        			    <img class="img-fluid float-left mb-3 mr-3" src="img/noticia1.jpg" alt="Inscripción para el curso de Formación de Cuidadores Domiciliarios">
        			    <h6>La Municipalidad de Viedma informa que a partir del lunes 26 de febrero comienza la etapa de asesoramiento, inscripción y entrevistas para el curso, perteneciente al Programa Nacional de Cuidadores Domiciliarios.</h6>
        		        <p class="text-justify">Este curso tiene como fin formar recurso humano calificado para la atención domiciliaria de Adultos Mayores, personas con discapacidad y/o portadoras de patologías crónicas, invalidantes y/o terminales, evitando o retrasando institucionalizaciones innecesarias, en el marco de la construcción de un sistema progresivo de atención.</p>
        		        <p class="text-justify">La capacitación es gratuita, con una duración de cuatro meses con certificación nacional. Los requisitos para realizarla son: presentar fotocopia de DNI, Constancia de Educación Primaria completa y tener entre 18 y 50 años.</p>
        		        <p class="text-justify">Los interesados podrán acercarse de lunes a viernes, de 15 a 17 a la Secretaría de Desarrollo Humano de la Municipalidad de Viedma, ubicada en calle Álvaro Barros 1508. Para más información comunicarse al teléfono 431400 Int: 510 o al mail: direccióndecoordinacionsdh@gmail.com</p>
        		        <p class="text-justify">Durante el mes de marzo, el Equipo de Coordinadores de Profesionales, llevará a cabo las inscripciones, entrevistas y selección de los potenciales alumnos.</p>
        		        <p class="text-justify">Programa Nacional “Cuidadores Domiciliarios” es llevado a cabo por el Ministerio de Desarrollo Social de la Nación a través de la Secretaría de Desarrollo Humano de la Municipalidad de Viedma.</p>
    		        </div>
    		        <div class="card-footer text-muted mb-3">
                    13/03/2018
                    </div>
